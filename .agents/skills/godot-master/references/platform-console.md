...
| :--- | :--- | :--- |
| 1. Boot | [console_boot_config.gd](../scripts/platform_console_console_boot_config.gd) | [server_side_projectile.gd](../scripts/platform_console_server_side_projectile.gd) — RID bypass, not cert |
| 2. Focus / disconnect | [certification_manager.gd](../scripts/platform_console_certification_manager.gd) | — |
| 3. Save atomicity | [async_save_manager.gd](../scripts/platform_console_async_save_manager.gd) | — |
| 4. FPS / scaler / RAM | [performance_scaler_fsr.gd](../scripts/platform_console_performance_scaler_fsr.gd) + [memory_budget_guard.gd](../scripts/platform_console_memory_budget_guard.gd) | Switch: set `ram_limit_mb` ≈ **3072** (retail) / warn at **3584**; PS/Xbox: **4096–5120** per SKU — see script `@export` |
| 5. Prompts | [controller_prompt_mapper.gd](../scripts/platform_console_controller_prompt_mapper.gd) | — |

**Optional only:** [achievement_offline_queue.gd](../scripts/platform_console_achievement_offline_queue.gd), [platform_dialog_invoker.gd](../scripts/platform_console_platform_dialog_invoker.gd), [background_data_prefetcher.gd](../scripts/platform_console_background_data_prefetcher.gd). **Do NOT Load** these during steps 1–5 unless achievements, system dialogs, or prefetch are in scope.
...
| Game runs when dashboard/home pressed | [certification_manager.gd](../scripts/platform_console_certification_manager.gd) focus-out pause | [Handling quit requests](https://docs.godotengine.org/en/stable/tutorials/inputs/handling_quit_requests.html) |
| "Press A" hardcoded on Switch | [controller_prompt_mapper.gd](../scripts/platform_console_controller_prompt_mapper.gd) GUID glyphs | [Controllers, gamepads, and joysticks](https://docs.godotengine.org/en/stable/tutorials/inputs/controllers_gamepads_joysticks.html) |
| Save corruption on power loss | [async_save_manager.gd](../scripts/platform_console_async_save_manager.gd) `.tmp` rename | [Saving games](https://docs.godotengine.org/en/stable/tutorials/io/saving_games.html) |
