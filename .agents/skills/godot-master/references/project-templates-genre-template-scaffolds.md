...
**game_manager.gd** skeleton — use [base_game_manager.gd](../scripts/project_templates_base_game_manager.gd):
...
Use [multi_platform_input.gd](../scripts/project_templates_multi_platform_input.gd) for device profiles.
...
- Feature tags (`mobile`, `low_end`) via [platform_feature_config.gd](../scripts/project_templates_platform_feature_config.gd).
...
**MANDATORY** [modular_dlc_loader.gd](../scripts/project_templates_modular_dlc_loader.gd).

## Expert: bootstrap priority

Replace linear Autoload list with prioritized boot — [bootstrap_config.gd](../scripts/project_templates_bootstrap_config.gd): config/network before audio/UI.
