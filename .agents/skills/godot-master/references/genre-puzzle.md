...
- NEVER ship dual undo authorities; strictly use Godot's built-in **UndoRedo** via [puzzle_undo_manager.gd](../scripts/genre_puzzle_puzzle_undo_manager.gd) — do **not** also maintain a hand-rolled Command stack.
...
> 1. [puzzle_undo_manager.gd](../scripts/genre_puzzle_puzzle_undo_manager.gd) — sole undo authority (`UndoRedo`)
> 2. [grid_manager.gd](../scripts/genre_puzzle_grid_manager.gd) — Vector2i grid as truth
> 3. [puzzle_state_validator.gd](../scripts/genre_puzzle_puzzle_state_validator.gd) — soft-lock / win checks on commit

### Original Expert Patterns
- [puzzle_undo_manager.gd](../scripts/genre_puzzle_puzzle_undo_manager.gd) - Godot `UndoRedo` wrapper for move do/undo (golden path).

### Modular Components
- [grid_manager.gd](../scripts/genre_puzzle_grid_manager.gd) - Vector2i board state decoupled from SceneTree.
- [grid_tween_mover.gd](../scripts/genre_puzzle_grid_tween_mover.gd) - Kill-before-recreate Tweens for piece moves.
- [puzzle_state_validator.gd](../scripts/genre_puzzle_puzzle_state_validator.gd) - Win / soft-lock validation after commits.
- [grid_input_manager.gd](../scripts/genre_puzzle_grid_input_manager.gd) - Snapped grid input.
- [match_three_logic.gd](../scripts/genre_puzzle_match_three_logic.gd) - Match-3 resolve / cascade helpers.
- [puzzle_pathfinder.gd](../scripts/genre_puzzle_puzzle_pathfinder.gd) - `AStarGrid2D` hints (`diagonal_mode`).
- [puzzle_saver.gd](../scripts/genre_puzzle_puzzle_saver.gd) - Level / snapshot serialization.
- [puzzle_validator.gd](../scripts/genre_puzzle_puzzle_validator.gd) - Broader solvability checks.
- [puzzle_history.gd](../scripts/genre_puzzle_puzzle_history.gd) - Thin UndoRedo action helpers (complements undo manager).
- [tile_animator.gd](../scripts/genre_puzzle_tile_animator.gd) - Tile juice without owning state.
- [shuffle_bag.gd](../scripts/genre_puzzle_shuffle_bag.gd) - Fair random piece bags.
- [perspective_overlay.gd](../scripts/genre_puzzle_perspective_overlay.gd) - Perspective / overlay puzzles.
- [sleepy_block.gd](../scripts/genre_puzzle_sleepy_block.gd) - Timed / sleeping block mechanic sample.

> **Do NOT load** [command_undo_redo.gd](../scripts/genre_puzzle_command_undo_redo.gd) — legacy hand-rolled Command stack superseded by `UndoRedo`.
...
|-------------|-----------------|
| Sokoban / push grid | [grid_manager.gd](../scripts/genre_puzzle_grid_manager.gd), [grid_tween_mover.gd](../scripts/genre_puzzle_grid_tween_mover.gd), [puzzle_undo_manager.gd](../scripts/genre_puzzle_puzzle_undo_manager.gd), [puzzle_state_validator.gd](../scripts/genre_puzzle_puzzle_state_validator.gd) |
| Match-3 | [match_three_logic.gd](../scripts/genre_puzzle_match_three_logic.gd), [grid_tween_mover.gd](../scripts/genre_puzzle_grid_tween_mover.gd), [puzzle_undo_manager.gd](../scripts/genre_puzzle_puzzle_undo_manager.gd) |
| Physics / spatial | Snap on settle → then same undo/validator path; do not treat rigid bodies as truth |
| Hints / solvers | [puzzle_pathfinder.gd](../scripts/genre_puzzle_puzzle_pathfinder.gd) (`AStarGrid2D.diagonal_mode`) |

### Undo authority
| Need | Action |
|------|--------|
| Player undo/redo | **Only** [puzzle_undo_manager.gd](../scripts/genre_puzzle_puzzle_undo_manager.gd) |
...
> **MANDATORY** for depth beyond decision trees and script catalog: [puzzle-elite-implementations.md](genre-puzzle-puzzle-elite-implementations.md). **Do NOT Load** on first-pass wiring — use bundled `scripts/` first.
