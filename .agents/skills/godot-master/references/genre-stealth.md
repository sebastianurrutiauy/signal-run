...
> 1. [stealth_patterns.gd](../scripts/genre_stealth_stealth_patterns.gd) — space-state LoS, cone DOT, hearing helpers
> 2. [stealth_ai_controller.gd](../scripts/genre_stealth_stealth_ai_controller.gd) — multi-sample rays + RID exclude + path-length hearing
> 3. [stealth_vision_cone.gd](../scripts/genre_stealth_stealth_vision_cone.gd) / [vision_cone_3d.gd](../scripts/genre_stealth_vision_cone_3d.gd) — cone authorship

### Original Expert Patterns
- [stealth_patterns.gd](../scripts/genre_stealth_stealth_patterns.gd) - Nodeless LoS, cone tests, AI_Audible bus, async investigate.
- [stealth_ai_controller.gd](../scripts/genre_stealth_stealth_ai_controller.gd) - Alert meter AI using PhysicsDirectSpaceState (not RayCast3D nodes).

### Modular Components
- [stealth_vision_cone.gd](../scripts/genre_stealth_stealth_vision_cone.gd) - 2D/logic cone helpers.
- [vision_cone_3d.gd](../scripts/genre_stealth_vision_cone_3d.gd) - 3D cone debug / query helpers.
- [visibility_manager.gd](../scripts/genre_stealth_visibility_manager.gd) - Player exposure / light gem aggregation.
- [light_detector.gd](../scripts/genre_stealth_light_detector.gd) - Light probe / overlap exposure.
- [sound_occlusion_manager.gd](../scripts/genre_stealth_sound_occlusion_manager.gd) - Occlusion / bus routing for AI hearing.
...
| Need | Action |
|------|--------|
| LoS + exclude self/player RIDs | **MANDATORY** [stealth_ai_controller.gd](../scripts/genre_stealth_stealth_ai_controller.gd) + [stealth_patterns.gd](../scripts/genre_stealth_stealth_patterns.gd) |
| Light-scaled detection | [visibility_manager.gd](../scripts/genre_stealth_visibility_manager.gd) / [light_detector.gd](../scripts/genre_stealth_light_detector.gd) |
| Hearing through geometry | Path-length via NavigationServer (controller) + [sound_occlusion_manager.gd](../scripts/genre_stealth_sound_occlusion_manager.gd) |
