...
- [lag_compensator.gd](../scripts/genre_battle_royale_lag_compensator.gd) - Server transform history + hit timestamp rewind validation.
- [monster_synchronizer.gd](../scripts/genre_battle_royale_monster_synchronizer.gd) - `MultiplayerSynchronizer` delta/on-change replication setup.
...
- [expert-battle-royale-patterns.md](genre-battle-royale-expert-battle-royale-patterns.md) — restored baseline pedagogy (architecture, WHY, implementation depth)
