...
| Mode | When | Script |
|------|------|--------|
| Hitscan | Rifles, SMGs — instant feedback | [shooter_patterns.gd](../scripts/genre_shooter_shooter_patterns.gd), [advanced_weapon_controller.gd](../scripts/genre_shooter_advanced_weapon_controller.gd) |
| Projectile | Rockets, arrows — gravity/bounce | [projectile.gd](../scripts/genre_shooter_projectile.gd) |
...
3. **Learnable pattern** — `Array[Vector2]` spray resource ([weapon_recoil_pattern.gd](../scripts/genre_shooter_weapon_recoil_pattern.gd))
...
| System | Script |
|--------|--------|
| Over-shoulder camera | [tps_camera_spring_arm.gd](../scripts/genre_shooter_tps_camera_spring_arm.gd) |
| Cover validity | [cover_validator_rays.gd](../scripts/genre_shooter_cover_validator_rays.gd) |
