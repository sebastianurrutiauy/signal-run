...
| Topic | Reference |
|-------|-----------|
| Snapshot / CI / fuzz / perf | [expert-testing-patterns.md](testing-patterns-expert-testing-patterns.md) |
| Release smoke checklist | [manual-testing-checklist.md](testing-patterns-manual-testing-checklist.md) |
