...
### [focus_prompt_icon_swapper.gd](../scripts/ui_theming_focus_prompt_icon_swapper.gd)
...
| Button/panel subtype | `theme_type_variation` | See [danger_button_assignment.gd](../scripts/ui_theming_danger_button_assignment.gd) |
| Runtime color tweak without mutating shared Theme | `stylebox.duplicate()` then override | See [dynamic_stylebox_color.gd](../scripts/ui_theming_dynamic_stylebox_color.gd) |
...
> **MANDATORY**: Read [danger_button_assignment.gd](../scripts/ui_theming_danger_button_assignment.gd) — do not fork Button scenes for color variants.
...
> **MANDATORY**: Read [dynamic_stylebox_color.gd](../scripts/ui_theming_dynamic_stylebox_color.gd) — never mutate a Theme StyleBox in place.
...
> **MANDATORY**: Read [theme_swapper.gd](../scripts/ui_theming_theme_swapper.gd) — swap at the theme root; do not walk every Control assigning themes.
...
> **MANDATORY**: Read [rtl_theme_mirroring.gd](../scripts/ui_theming_rtl_theme_mirroring.gd) — swap theme variants from layout direction; do not hardcode LTR margins.
...
> **MANDATORY**: Read [focus_prompt_icon_swapper.gd](../scripts/ui_theming_focus_prompt_icon_swapper.gd) — do not paste joypad icon paths into Control scripts.

Pairs with Runtime-Theme-Swapping (Accessibility) above and [theme_swapper.gd](../scripts/ui_theming_theme_swapper.gd) for High-Contrast roots.
