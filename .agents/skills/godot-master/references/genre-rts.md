...
- [rts_formation_manager.gd](../scripts/genre_rts_rts_formation_manager.gd) — Center-of-mass group path + per-unit formation offsets.
- [rts_massive_unit_renderer.gd](../scripts/genre_rts_rts_massive_unit_renderer.gd) — MultiMeshInstance3D army renderer synced from unit transforms.
...
> **MANDATORY** for depth beyond decision trees and script catalog: [rts-mass-army-deep.md](genre-rts-rts-mass-army-deep.md). **Do NOT Load** on first-pass wiring — use bundled `scripts/` first.
