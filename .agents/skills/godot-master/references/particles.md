...
- Collision sub-emitters, fluid shaders, VFX pools → [expert-vfx-patterns.md](particles-expert-vfx-patterns.md)
- VFX pool recycle pattern → [vfx_pool_manager.gd](../scripts/particles_vfx_pool_manager.gd)
