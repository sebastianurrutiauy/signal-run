...
> 1. [big_number.gd](../scripts/genre_idle_clicker_big_number.gd) — mantissa + exponent beyond float INF
> 2. [generator.gd](../scripts/genre_idle_clicker_generator.gd) — exponential cost / rate units
> 3. [scientific_notation_formatter.gd](../scripts/genre_idle_clicker_scientific_notation_formatter.gd) — K/M/B/T + scientific display
> 4. [offline_progress_calculator.gd](../scripts/genre_idle_clicker_offline_progress_calculator.gd) — UNIX offline catch-up (not `ticks_msec`)

### Original Expert Patterns
- [big_number.gd](../scripts/genre_idle_clicker_big_number.gd) - Mantissa + Exponent math for e308+ scales.
- [generator.gd](../scripts/genre_idle_clicker_generator.gd) - Exponential cost units and production rate calculation.
- [scientific_notation_formatter.gd](../scripts/genre_idle_clicker_scientific_notation_formatter.gd) - Readable K/M/B/T and scientific suffixes.
...
- [functional_income_reducer.gd](../scripts/genre_idle_clicker_functional_income_reducer.gd) - Fast income summation patterns.
- [threaded_catchup_simulator.gd](../scripts/genre_idle_clicker_threaded_catchup_simulator.gd) - WorkerThreadPool background catch-up.
- [precision_cost_validator.gd](../scripts/genre_idle_clicker_precision_cost_validator.gd) - Cost curve / affordability checks.
- [scientific_notation_math.gd](../scripts/genre_idle_clicker_scientific_notation_math.gd) - Shared mantissa helpers for formatters.
- [idle_performance_setup.gd](../scripts/genre_idle_clicker_idle_performance_setup.gd) - `low_processor_usage_mode` + signal-throttled UI.
- [decoupled_economy_signal_bus.gd](../scripts/genre_idle_clicker_decoupled_economy_signal_bus.gd) - Throttled economy→UI signals.
- [lightweight_upgrade_resource.gd](../scripts/genre_idle_clicker_lightweight_upgrade_resource.gd) - Upgrade `.tres` pattern.
- [big_int_save_parser.gd](../scripts/genre_idle_clicker_big_int_save_parser.gd) - Persist big numbers safely.
- [thread_safe_ui_updater.gd](../scripts/genre_idle_clicker_thread_safe_ui_updater.gd) - Deferred UI after threaded catch-up.
...
| Need | Action |
|------|--------|
| Values past ~1e308 | **MANDATORY** [big_number.gd](../scripts/genre_idle_clicker_big_number.gd) |
| Labels / abbreviations | **MANDATORY** [scientific_notation_formatter.gd](../scripts/genre_idle_clicker_scientific_notation_formatter.gd) |
| Cost curve ~1.15^n | [generator.gd](../scripts/genre_idle_clicker_generator.gd) + [precision_cost_validator.gd](../scripts/genre_idle_clicker_precision_cost_validator.gd) |

### Offline & perf
| Need | Action |
|------|--------|
| Offline catch-up | **MANDATORY** [offline_progress_calculator.gd](../scripts/genre_idle_clicker_offline_progress_calculator.gd) (UNIX time) |
| Long catch-up | [threaded_catchup_simulator.gd](../scripts/genre_idle_clicker_threaded_catchup_simulator.gd) |
| Battery / idle CPU | [idle_performance_setup.gd](../scripts/genre_idle_clicker_idle_performance_setup.gd) |
