...
- Re-check renamed project settings / enums after convert (enable Advanced).
- Environment quality knobs moved to Project Settings — menus that mutated Environment need `RenderingServer` APIs.
- VCS ignore lists differ 3.x vs 4.x — update `.gitignore`.
- Editor settings file is separate (`editor_settings-4.tres`).
